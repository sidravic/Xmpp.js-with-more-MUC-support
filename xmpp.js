...
//        console.log("sent: "+s);
    ...
    // support for presence without room
	self.presence_info = function(status, jid){
		full_jid  = jid;
		self.send(PRESENCE[0] + full_jid + PRESENCE[1] + full_jid + PRESENCE[2] + status + PRESENCE[3])
	}
